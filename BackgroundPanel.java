/*
 * All of this code is coppied form: http://www.camick.com/java/source/BackgroundPanel.java
 * I couldn't figure out how to do this in a simpler way though I'm sure there is one
 * but the simple fixes i found for text over an image just weren't working for me
 * so it just implemetns this class
 * 
 * 
 * 
 */
